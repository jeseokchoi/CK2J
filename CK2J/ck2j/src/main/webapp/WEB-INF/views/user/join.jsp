...
<div class="agreementDiv">
	<fieldset class="agreementFieldset">
		<p>
			<textarea class="agreement">제1조(목적)
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.    2. 등록 내용에 허위, 기재누락, 오기가 있는 경우
    3. 기타 회원으로 등록하는 것이 “몰”의 기술상 현저히 지장이 있다고 판단되는 경우
  ③ 회원가입계약의 성립 시기는 “몰”의 승낙이 회원에게 도달한 시점으로 합니다.
  ④ 회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간 이내에 “몰”에 대하여 회원정보 수정 등의 방법으로 그 변경사항을 알려야 합니다.</textarea>
		</p>
...
<div class="agreementDiv">
	<fieldset class="agreementFieldset">
		<p>
			<textarea class="agreement">1. 개인정보 수집목적 및 이용목적
...
2. 수집하는 개인정보 항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택 전화번호 , 휴대전화번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의 정보,주소,환불계좌
...
“업체명”은 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다.

“업체명”의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.
...
- 보유기간 : 회원 탈퇴 시 혹은 법정 보유기간</textarea>
		</p>
		<p class="agreementCheck">
...
<div class="agreementDiv">	
	<fieldset class="agreementFieldset">
		<p>
			<textarea class="agreement">할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 쇼핑정보를 SMS나 이메일로 받아보실 수 있습니다.
