...
<link rel="stylesheet" href="${cpath }/resources/css/newSpring/user/user_return.css" type="text/css"/>

<script src="${cpath }/resources/js/newSpring/user/user_return.js"></script>
...
<!-- 		 class="orderDetailC"> -->
		...
		<tr>
			...
			<td><a href="${cpath }/product/view/${dto.product_idx}"><img src="${cpath }/itemImg/${list.product_t_img }" 
			style=" width: 100px; height: 100px;  border: 2px solid #848484;"></a></td>
...
<div class="orderDetailAa">
	...
	<form class="searchForm" method="POST" action="${cpath }/user/exchange/${list.product_opt_idx}/${list.product_idx}/${list.userOrder_detail_idx}">
	
		<p>
		<p class="product_size">사이즈 교환</p>
		<input type="hidden" name="product_idx" value="${list.product_idx}">
		<input type="hidden" name="userOrder_detail_idx" value="${list.userOrder_detail_idx}">
<%-- 		<input type="hidden" name="userOrder_detail_idx" value="${list.product_opt_idx}"> --%>
		...
		<select name="product_color" required="required">
			<option value="">== 카테고리를 선택하세요 ==</option>
...
<div class="orderDetailAb">
	...
	<form method="POST" action="${cpath }/user/refund/${list.product_opt_idx}/${list.product_idx}/${list.userOrder_detail_idx}">
...
<!-- 		<p><input type="submit" value="환불신청"> -->
